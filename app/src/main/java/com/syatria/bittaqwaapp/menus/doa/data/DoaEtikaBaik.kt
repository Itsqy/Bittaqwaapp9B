...
object DoaEtikaBaik {
    ...
    val listDoaEtikaBaik: ArrayList<DoaModel>
        get() {
            ...
            for (data in doaTitle.indices) {
                val doa = DoaModel()
                doa.judulDoa = doaTitle[data]
                doa.arabDoa = doaDoa[data]
                doa.latinDoa = doaLatin[data]
                doa.artiDoa = doaTranslate[data]
                doa.riwayatDoa = doaProfile[data]
                list.add(doa)
            }
